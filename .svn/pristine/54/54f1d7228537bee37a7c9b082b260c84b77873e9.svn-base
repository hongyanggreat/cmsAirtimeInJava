 ...
 */
package com.htc.airtime.servlet.userPermission;
 ...
 * @author Admin
 */
@WebServlet(name = "addUserPermission", urlPatterns = {"/addUserPermission"})
                        ...
                        if (moduleChecked) {
                            ...
                            if (actionModule.equals("updateOne") || actionModule.equals("addOne")) {
                                ...
                                try {
                                    ...
                                    if (!rs) {
                                        redirectURL = baseUrl + "/userPermission/list.jsp?id=" + idAcc;
                                    } else {
                                        redirectURL = baseUrl + "/userPermission/list.jsp?id=" + idAcc;
                                    }
