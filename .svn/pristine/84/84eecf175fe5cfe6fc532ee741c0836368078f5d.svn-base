...
public class ChargeDAO {
    ...
    public static String table = "artime_request_charge";
...
//            DBConnect.freeConn(rs, pstm, conn);
    ...
    public ArrayList<AirtimeReq> getListStatistic(String msisdn, String formDate, String toDate, String user, String cpCode, String cpGame, String price, String status, ArrayList<Account> arrAcc) throws SQLException {
        Connection conn = null;
        PreparedStatement pstm = null;
        ResultSet rs = null;
        ArrayList list = new ArrayList();
...
//        String sql = "SELECT * FROM "+table;
        String sql = "SELECT CP_CODE,USER_NAME,GAME_CODE,RS_MPS,RS_AHP,SUM(PRICE) as TOTAL_AMOUNT,COUNT(ID) as TOTAL_REQUEST FROM " + table;
        sql += " WHERE 1=1";
        if (!Tool.checkNull(msisdn)) {
            sql += " AND MSISDN = ?";
        }
        ...
        sql += " GROUP BY CP_CODE,USER_NAME,GAME_CODE,RS_MPS,RS_AHP";
        sql += " ORDER BY USER_NAME DESC , GAME_CODE ASC";
...
//            conn = DBConnect.getConnection();
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    dt.setRsMps(rs.getString("RS_MPS"));
                    dt.setRsAhp(rs.getString("RS_AHP"));
                    dt.setTotalAmount(rs.getInt("TOTAL_AMOUNT"));
                    dt.setTotalReq(rs.getInt("TOTAL_REQUEST"));
