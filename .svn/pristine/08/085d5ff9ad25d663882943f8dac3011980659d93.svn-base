 ...
 * @author Admin
 */
@WebServlet(name = "delete", urlPatterns = {"/airtimeManager/delete"})
public class delete extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            // BO XUNG KIEM TRA CO QUYEN KHONG
            if (!Tool.checkNull(request.getParameter("id"))) {
                id = Integer.parseInt(request.getParameter("id"));
                UserServicesDAO userServicesDAO = new UserServicesDAO();
                if (userServicesDAO.delete(id)) {
